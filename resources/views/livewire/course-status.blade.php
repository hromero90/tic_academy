    ...
    <div class="container grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="text-gray text-sm mt-2">{{$this->advance ."%"}} Completado</p>

                <div class="relative pt-1">
                    <div class="overflow-hidden h-2 mb-4 text-xs flex rounded bg-gray-200">
                      <div style="width:{{$this->advance ."%"}}" class="shadow-none flex flex-col text-center whitespace-nowrap text-white justify-center bg-blue-500 transition-all duration-5000"></div>
                    </div>
                  </div>
